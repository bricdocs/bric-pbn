/**
 * ============================================================================
 * TEK KARE MASA KIRPMA VE YÖN ATAMA MODÜLÜ (cropscript.js)
 * ============================================================================
 */
...
function resetDirections() {
    ...
    const actionBtn = document.getElementById('btnSendToAnalysis');
...
function setNorthPosition(northIndex) {
    ...
    banner.innerHTML = '✅ Kuzey belirlendi! Tüm yönler atandı. Artık analize gönderebilirsiniz.';
}
